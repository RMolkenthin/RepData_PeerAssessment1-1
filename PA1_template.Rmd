...
```{r MeanAndMedianOfTotalSteps, echo = TRUE}
...
```{r MaximumStepsAndInterval, echo = TRUE}
...
```{r MissingValuesReplacement, echo = TRUE, warning = FALSE}
...
```{r HistogramAfterReplacement, echo = TRUE}
...
```{r MeanAndMedianAfterReplacement, echo = TRUE}
...
```{r WeekdaysWeekendsData, echo = TRUE}
...
```{r WeekdaysWeekendsPlot, echo = TRUE}
## panel plot
